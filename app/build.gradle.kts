...
android {
    namespace = "com.personal.inkpad"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.personal.inkpad"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
        ...
        buildConfigField("String", "GOOGLE_WEB_CLIENT_ID", "\"${escapeForBuildConfig(googleWebClientId)}\"")
    }

    buildTypes {
        release {
            isMinifyEnabled = false
            // Sign with the local debug key so family can sideload without a Play Store keystore
